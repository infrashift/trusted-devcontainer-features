...
# TARGET_VERSION and TARGET_PYTHON_VERSION are defined in devcontainer-feature.json
...
uv run --with ansible-core ansible-playbook \
    ...
    -e "ansible_core_version=${TARGET_VERSION}" \
    -e "target_python_version=${TARGET_PYTHON_VERSION}"
