...
# TARGET_VERSION and TARGET_CHECKSUM are defined in devcontainer-feature.json
...
uv run --with ansible-core ansible-playbook \
    ...
    -e "grype_version=${TARGET_VERSION}" \
    -e "grype_checksum=${TARGET_CHECKSUM}"
